    ...
    rounds: [
      {
        ...
        matches: [
          ...
          { team1: 'Sweden', team2: 'Austria', score1: 0, score2: 0 },
...
export function getKnockout(year: number): BracketRound[] {
  return allBrackets.find((d) => d.year === year)?.rounds ?? []
}
